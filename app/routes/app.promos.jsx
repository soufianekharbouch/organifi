      ...
      <Layout.Section>
        ...
        <Card>
          <DataTable
            ...
            headings={["Promo Title", "Promo Type", "Actions"]}
            rows={rows}
          />
        </Card>
      </Layout.Section>
        ...
        <Modal.Section>
          <TextContainer>
            ...
            {selectedPromoDetails.type === "product_target" && (
              <>
                <p><strong>Target Product:</strong> {safeParseJSON(selectedPromoDetails.targetProduct).title || "N/A"}  &ensp; &ensp; &ensp; <strong>Quantity:</strong> {selectedPromoDetails.targetQuantity|| "N/A"}</p>
                <p><strong>Gift Product:</strong> {safeParseJSON(selectedPromoDetails.giftProduct).title || "N/A"}&ensp; &ensp; &ensp; <strong>Quantity:</strong> {selectedPromoDetails.giftQuantity|| "N/A"}</p>
              </>
            )}
            {selectedPromoDetails.type === "collection_target" && (
              <>
                <p><strong>Target Collection:</strong> {safeParseJSON(selectedPromoDetails.collectionTarget).title || ""}</p>
                <p><strong>Gift Product:</strong> {safeParseJSON(selectedPromoDetails.giftProduct).title || "N/A"}&ensp; &ensp; <strong>Quantity:</strong> {selectedPromoDetails.giftQuantity|| "N/A"}</p>
              </>
            )}
